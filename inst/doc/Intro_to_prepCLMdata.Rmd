---
title: "Introduction to prepCLMdata"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to prepCLMdata}
...
# An Introduction to the *prepCLMdata* Package #

## Introduction ##

The *prepCLMdata* R package is designed to prepare climate data (in particular, that from WorldClim) for species niche modelling in DIVA-GIS. 
...
Please cite as:
Chan, K. (2023) prepCLMData R package (Version 0.1.0). Available from: https://github.com/DrKrisChan/prepCLMdata/issues
